...
var showAlert = function showAlert(type, msg) {
  hideAlert(); //const markup = `<div class="alert alert--${type}">${msg}</div>`;

  document.querySelector('body').insertAdjacentHTML('afterbegin', "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"));
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1Ijoic2h1Ymhhc2hpc2g3NyIsImEiOiJja3hyOXRyMjExeGtmMndrbzVocGszNTVwIn0.fl1e9mxZ6iTPy4SIHlhu6g";
  var map = new mapboxgl.Map({
    container: "map",
    // container ID
    style: "mapbox://styles/shubhashish77/ckxrasdwq7nbt15qztib8s0sl",
    // style URL
